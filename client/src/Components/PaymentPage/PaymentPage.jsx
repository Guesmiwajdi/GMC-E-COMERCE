...
export default function PaymentPage() {
  ...
  const initPayment = (data) => {
    const options = {
      ...
      handler: async (response) => {
        try {
          const verifyUrl = "https://alok-mern.herokuapp.com/api/payment/verify";
  ...
  const handlePayment = async () => {
    try {
      const orderUrl = "https://alok-mern.herokuapp.com/api/payment/orders";
      ...
      <div className='PaymentPageFlex'>
        ...
        <div className='PaymentDetailsDiv'>
          <div className='bankOfferDiv'>
            ...
            <div><p>10% off Instant Discount on master Cards on a min spend of 1.000</p></div>
          ...
          <div className='PaymentModeSelectdiv'>
            ...
            <div className='payOptionDetails'>
              <div>
                <div className='totolAmt paymentHeading'></div>
